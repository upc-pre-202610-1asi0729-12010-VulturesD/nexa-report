...
#### S1 — Commercial Coordination: mockups mobile de pedido asistido

![S1 Mock Ups](../assets/images/chapter-4/webapp/mockups/commercial-mobile.png)

#### S2 — Operations / Account Owner: mockups mobile de operación logística

![S2 jefatura logística](../assets/images/chapter-4/webapp/mockups/operator-mobile.png)

#### S3 — B2B Buyer Portal: mockups mobile de autoservicio B2B
