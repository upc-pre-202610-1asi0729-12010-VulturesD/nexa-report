...
| Web Application | Angular 18, TypeScript, Angular Material, Angular Router y HttpClient | Proporciona la experiencia transaccional para compradores B2B, usuarios comerciales y usuarios de operaciones. |
| RESTful API | Java Spring Boot REST API | Expone application services y operaciones de dominio para catálogo, ventas, almacén, logística e invoicing. |
