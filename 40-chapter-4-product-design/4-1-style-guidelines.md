...
En la implementación final, estos lineamientos se materializan en una Landing Page construida con HTML5, CSS3 y JavaScript, y en una Web Application desarrollada con Angular 21, PrimeAngular, PrimeFlex, PrimeIcons y Angular I18n. De esta manera, las decisiones visuales no quedan solo como referencia gráfica, sino que se conectan con componentes reutilizables, estados de interfaz, navegación responsive, soporte bilingüe y criterios de accesibilidad aplicados en las superficies finales del producto.
