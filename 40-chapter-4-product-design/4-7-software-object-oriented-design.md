...
'
E'l mapa táctico resume la relación entre bounded contexts, aggregates y componentes de soporte transversal.
...
'
I'dentity and Access se representa como soporte transversal para autenticación, autorización y control de acceso basado en tenants.
...
'
C'atalog Management gestiona productos, categorías, promociones, visibilidad del producto e información de conservación.
...
'
S'ales gestiona clientes B2B, solicitudes de compra, validación comercial y órdenes de venta confirmadas.
...
'
W'arehouse gestiona almacenes, lotes de inventario, reservas de stock, movimientos de stock y criterios FEFO.
...
'
L'ogistics gestiona órdenes de despacho, eventos de trazabilidad, incidencias de entrega, controles de temperatura y evidencia de entrega.
...
'
I'nvoicing gestiona documentos comerciales, resúmenes de cobro, pagos simulados y visibilidad del estado de pago.
...
Para mantener la trazabilidad con los requisitos, esta matriz relaciona algunas historias de usuario con las clases que sostienen cada flujo.
