...
<table>
  <tr>
    <td width="50%">
      <p><a href="https://github.com/upc-pre-202610-1asi0729-12010-VulturesD/nexa-website">nexa-website</a></p>
  ...
  <tr>
    ...
    <td width="50%">
      <p><a href="https://github.com/upc-pre-202610-1asi0729-12010-VulturesD/nexa-report">nexa-report</a> (This Repository)</p>
...
1.  **Clone the Repository**:
    ```bash
    git clone https://github.com/upc-pre-202610-1asi0729-12010-VulturesD/nexa-report.git
    ```
2.  **Navigation**:
