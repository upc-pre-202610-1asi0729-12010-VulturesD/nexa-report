...
| URL final de Platform API | `5.1` y `5.2.4.7` ya deben apuntar a `https://nexa-platform.onrender.com` y Swagger a `/swagger/index.html`. | Aun existen referencias historicas `https://nexa-platform-api.onrender.com` en conclusiones, annexes y release notes. | Decidir si esas referencias son historicas AV2 o deben actualizarse. Para cierre TB2, usar solo `https://nexa-platform.onrender.com`. |
...
7. Revisar evidencia de deployment:
   ...
   - WebApp Render.
   - Platform API Render `https://nexa-platform.onrender.com`.
   - Swagger `https://nexa-platform.onrender.com/swagger/index.html`.
...
- Corregida la Platform API final a `https://nexa-platform.onrender.com` en evidencia de deployment vigente.
