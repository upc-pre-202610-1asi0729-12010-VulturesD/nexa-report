...
| Sprint 4 Goal | <div align="justify">**Nuestro foco** está en consolidar la versión final operativa de Nexa mediante la integración completa entre la Landing Page, la Web Application y los Web Services, cerrando los flujos principales de conversión, compra B2B, gestión operativa, facturación y soporte técnico para frontend. **Creemos que esto** entrega una experiencia de conversión más clara a los visitantes de la Landing Page, mayor autonomía transaccional a los compradores B2B, mejor control operativo sobre pedidos, despachos y comprobantes al personal de ventas, logística y administración, y un entorno integrado y estable a los desarrolladores frontend para consumir servicios reales sin depender de mocks. **Esto será confirmado cuando** los visitantes accedan desde la Landing Page a las vistas correspondientes de la Web Application; los compradores B2B completen solicitudes comerciales y consulten el estado de sus pedidos; el personal operativo gestione pedidos, distribución y facturación con datos persistidos en PostgreSQL; y los desarrolladores frontend validen el consumo exitoso de la API RESTful desplegada, bajo políticas de autenticación, autorización e integración multi-tenant.</div> |
...
|---|---|---|---|---|
| Landing Page nexa-website | GitHub Pages | v4.0.1 | https://upc-pre-202610-1asi0729-12010-VulturesD.github.io/nexa-website/ | Website público desplegado. |
| Web Application nexa-webapp | Render Static Site | v3.0.1 | https://nexa-webapp.onrender.com | WebApp para revisión académica. |
| Platform API nexa-platform | Render Web Service | v2.0.1 | https://nexa-platform.onrender.com | API con health y Swagger/OpenAPI. |
| PostgreSQL | Render PostgreSQL | No aplica | No se expone host interno. | Persistencia documentada sin secretos. |
| Swagger/OpenAPI | Platform API | v2.0.1 | https://nexa-platform.onrender.com/swagger/index.html | Documentación interactiva. |
