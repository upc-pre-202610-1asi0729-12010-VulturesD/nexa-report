...
El repositorio `nexa-webapp` registra la primera versión de la Web Application, incluyendo estructura Angular, routing, layouts, IAM simulado, flujos Segmento 1/Segmento 2, portal comprador parcial, Fake API, servicios cliente y preparación de release. `nexa-website` registra la actualización del Landing Page, contenido, SEO, páginas legales, rutas y releases. La trazabilidad del informe académico se consolida en Project Report Collaboration Insights.
...
|---|---|---|---|
| Web Application foundation | Aplicación Angular configurada con routing, layouts, IAM simulado, i18n, utilidades compartidas y estructura inicial de dominios frontend. | `nexa-webapp`: `508aeb2`, `3a21842`, `21bf5b6`, `7ecc433`, `bf841d8`, `abe36c3` | No representa integración con backend productivo. |
