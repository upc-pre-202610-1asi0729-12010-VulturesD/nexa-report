...
El repositorio `nexa-webapp` registra la primera versión de la Web Application, incluyendo estructura Angular, routing, layouts, IAM simulado, flujos S1/S2, portal comprador parcial, API client, servicios cliente y preparación de release. El repositorio `nexa-website` registra la actualización del Landing Page para conectarse con la Web Application, reforzar contenido, SEO, páginas legales, rutas y versiones de release. El repositorio `nexa-report` conserva la evidencia documental del Sprint 2, incluyendo backlog, diseño UX/UI, evidencia de implementación, despliegue, colaboración y cierre TB1.
...
|---|---|---|---|---|---|
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `508aeb2` | `build(angular): configure Angular webapp toolchain` | | 2026-04-27 |
...
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `bf841d8` | `feat(shared): add HTTP and utility foundation` | | 2026-04-28 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `abe36c3` | `feat(i18n): add bilingual locale structure` | | 2026-04-28 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `7ad15fc` | `feat(fake-api): add json-server service scaffold` | | 2026-04-28 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `44bf98d` | `chore(release): merge webapp v0.2.0 to main` | | 2026-04-29 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `949c5da` | `feat(dashboard): add operational analytics route` | | 2026-05-02 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `f4ce731` | `feat(analytics): add operational analytics API adapter` | | 2026-05-02 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `3fb66ed` | `feat(analytics): add dashboard application store` | | 2026-05-02 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `13b4e1d` | `feat(sales): add client account route surface` | | 2026-05-03 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `6b50a5b` | `feat(sales): add client account data layer` | | 2026-05-03 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `bc4198b` | `feat(sales): add purchase order routes and views` | | 2026-05-03 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `8ba2bde` | `feat(logistics): add dispatch board routes` | | 2026-05-04 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `f4fa86a` | `feat(logistics): map dispatch order API resources` | | 2026-05-04 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `8e9ce33` | `feat(logistics): add dispatch order store` | | 2026-05-04 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `ea5cb6b` | `feat(warehouse): add inventory control routes` | | 2026-05-05 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `90e3f29` | `feat(warehouse): add inventory domain model` | | 2026-05-05 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `e34d95d` | `feat(warehouse): map inventory lot resources` | | 2026-05-05 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `43adef7` | `feat(warehouse): add inventory control store` | | 2026-05-05 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `2dceefe` | `feat(catalog): add catalog management routes` | | 2026-05-06 |
...
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `0b02c8f` | `chore(release): prepare webapp v1.0.1` | | 2026-05-12 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `c3bc9ca` | `fix(release): merge webapp v1.0.1 routing hotfix` | | 2026-05-12 |
...
| Repository | Branch | Commit Id | Commit Message | Commit Message Body | Commited on (Date) |
|---|---|---|---|---|---|
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `1d9e5be` | `chore(gitflow): merge i18n-content into develop` | | 2026-04-28 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `bbce32b` | `feat(i18n): update bilingual content mappings` | | 2026-04-28 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `5b03e59` | `chore(release): prepare website v1.1.0` | | 2026-04-29 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `6ca19f3` | `chore(release): merge website v1.1.0 to main` | | 2026-04-29 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `552fe24` | `refactor(interactions): refine static page behavior` | | 2026-04-30 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `c6b22bb` | `chore(release): prepare website v1.2.0` | | 2026-05-01 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `b78d11f` | `chore(release): merge website v1.2.0 to main` | | 2026-05-01 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `1ab8c54` | `feat(legal): add website legal pages` | | 2026-05-02 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `32de637` | `chore(release): prepare website v2.0.0` | | 2026-05-03 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `fa16b58` | `chore(release): merge website v2.0.0 to main` | | 2026-05-03 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `5da8147` | `fix(pricing): add pricing route fallback` | | 2026-05-04 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `a7f4904` | `fix(release): merge website v2.0.1 hotfix to main` | | 2026-05-04 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `77af8b3` | `feat(pricing): add plans page and pricing scripts` | | 2026-05-05 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `d61d321` | `chore(release): merge website v2.1.0 to main` | | 2026-05-07 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `0120ead` | `feat(cookies): add cookie notice behavior` | | 2026-05-08 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `dc7a296` | `chore(release): prepare website v2.2.0` | | 2026-05-09 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `a421767` | `chore(release): merge website v2.2.0 to main` | | 2026-05-09 |
...
|---|---|---|---|
| Web Application foundation | Aplicación Angular configurada con routing, layouts, IAM simulado, utilidades compartidas y estructura inicial de dominios frontend. | `nexa-webapp`: `508aeb2`, `3a21842`, `21bf5b6`, `7ecc433`, `bf841d8`, `abe36c3` | No representa integración con backend productivo. |
...
| Project Report TB1 | Documentación del Sprint 2, evidencia de implementación, despliegue, backlog, UX/UI y cierre documental. | `nexa-report`: `34e30a0`, `72cf226`, `870bc73`, `fbda62a`, `4eb34fe`, `777c3ba` | Evidencia documental, no evidencia de backend productivo. |
...
| Backend Spring Boot | Planificado para fase posterior | `nexa-platform` y arquitectura objetivo | No implementado como Web Services de TB1. |
...
|---|---|---|
| Coordinación del incremento | Planificación de Sprint 2, Sprint Backlog y cierre documental en `nexa-report` | El equipo mantuvo una línea clara entre alcance TB1, evidencia de implementación y documentación del reporte. |
...
| Documentación académica | Commits en `nexa-report` asociados a Sprint 2, UX/UI, backlog, despliegue y evidencia | El informe conserva trazabilidad entre diseño, backlog, implementación, despliegue y colaboración. |
...
| UX/UI y documentación | Actualizaciones del Capítulo 4 y Capítulo 5 en `nexa-report` |
