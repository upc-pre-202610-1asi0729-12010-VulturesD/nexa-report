...
> *Nota:* La planificación muestra una referencia de `241 horas`, mientras la captura de Jira registra `213 de 213`. Al no existir una única fuente coincidente, la métrica debe validarse contra Jira antes de presentarse como valor definitivo. Elaboración propia.
...
El Sprint Backlog 3 concentra el trabajo asociado al primer corte AV2 frontend/backend y a la consolidación de la base backend de Nexa Platform. Su objetivo principal fue establecer una base técnica coherente para la primera Web Services API, organizada por bounded contexts, con controladores iniciales, Shared Kernel, patrones de repositorio, Unit of Work, persistencia mediante JPA/Hibernate/PostgreSQL para el despliegue controlado y trazabilidad de release para revisar la transición desde mocks hacia backend real.
...
| Sprint 3 | Task | Foundation backend con DDD | NX-116 | TS-NX-003-002 - Scaffold Spring Boot y DDD | Preparar la estructura inicial en Spring Boot y la organización Domain-Driven Design del backend. | 8.0 | Gerard Gianpier Rojas Mancilla | Finalizado |
| Sprint 3 | Task | Persistencia y dominio backend | NX-122 | TS-NX-003-003 - Implementar JPA/Hibernate y entidades de dominio | Incorporar JPA/Hibernate y las entidades de dominio necesarias para la persistencia de la Platform API. | 13.0 | César Marín | Finalizado |
...
| Sprint 3 | Task | Pruebas unitarias de catálogo | NX-262 | TS-NX-003-008 - Configurar JUnit y escribir pruebas unitarias del módulo de catálogo | Configurar JUnit y Mockito y cubrir búsqueda, filtros, paginación y acceso por cuenta del módulo de catálogo. | 8.0 | Diego Yucra Sandoval | Finalizado |
| Sprint 3 | Task | Pruebas end-to-end | NX-265 | TS-NX-003-009 - Configurar pruebas E2E con Playwright para flujos críticos | Configurar pruebas E2E para login, catálogo, creación de pedidos y descarga de órdenes, integradas al flujo de CI. | 10.0 | Diego Yucra Sandoval | Cancelado (No implementado) |
...
| Sprint 3 | Task | Backend foundation de Nexa Platform | NX-856 | TS-NX-003-001 - Configurar Spring Boot Web API foundation | Preparar Java 21, Spring Boot, Maven pom.xml, controladores REST, Swagger/OpenAPI y configuración base para ejecución local. | 8.0 | Diego Yucra Sandoval | Finalizado |
...
| Sprint 3 | Task | Persistencia relacional AV2 | NX-862 | TS-NX-003-007 - Preparar foundation de persistencia relacional | Configurar JPA/Hibernate y la base de persistencia relacional requerida por el despliegue controlado de AV2. | 5.0 | Joaquín Francisco Verde Bueno | Finalizado |
...
| Sprint 3 | Task NX-116 | NX-116 | Scaffold Spring Boot y DDD | NX-120 | Crear proyectos .NET y referencias | Crear los proyectos de la solución y configurar sus referencias. | — | Gerard Gianpier Rojas Mancilla | Finalizado |
| Sprint 3 | Task NX-116 | NX-116 | Scaffold Spring Boot y DDD | NX-121 | Configurar inyección de dependencias (IoC) | Registrar las dependencias y servicios requeridos por la solución. | — | Gerard Gianpier Rojas Mancilla | Finalizado |
| Sprint 3 | Task NX-122 | NX-122 | Implementar JPA/Hibernate y entidades de dominio | NX-123 | Codificar entidades Company, User y Order | Implementar las entidades de dominio principales para la persistencia. | — | César Marín | Finalizado |
| Sprint 3 | Task NX-122 | NX-122 | Implementar JPA/Hibernate y entidades de dominio | NX-124 | Configurar Entidades de JPA y anotaciones de mapeo | Configurar el contexto de JPA/Hibernate y el mapeo relacional. | — | César Marín | Finalizado |
| Sprint 3 | Task NX-122 | NX-122 | Implementar JPA/Hibernate y entidades de dominio | NX-125 | Ejecutar migración creación de tablas | Crear y ejecutar la migración inicial de la base de datos. | — | César Marín | Finalizado |
...
| Sprint 3 | Task NX-856 | NX-856 | Configurar Spring Boot Web API foundation | NX-1060 | Inicialización de la Solución | Crear la jerarquía de directorios con DDD y configurar la solución para separar responsabilidades. | 6.0 | Diego | Por hacer |
| Sprint 3 | Task NX-856 | NX-856 | Configurar Spring Boot Web API foundation | NX-1061 | Implementación de Swagger | Habilitar Swagger para visualizar y probar endpoints, manteniendo actualizado el contrato de API. | 6.0 | Diego | Por hacer |
...
| Sprint 3 | Task NX-862 | NX-862 | Preparar foundation de persistencia relacional | NX-1072 | Validaciones de conectividad | Verificar la conectividad con el servidor PostgreSQL durante el arranque de la aplicación. | 4.0 | Joaquín Francisco Verde Bueno | Por hacer |
| Sprint 3 | Task NX-862 | NX-862 | Preparar foundation de persistencia relacional | NX-1073 | Configuración del driver de conexión | Configurar el proveedor de datos y los parámetros de conexión entre Spring Boot y PostgreSQL. | 6.0 | Joaquín Francisco Verde Bueno | Por hacer |
...
| Sprint 3 | Task NX-866 | NX-866 | Prepare frontend/backend release version for AV2 | NX-1080 | Verificación de consistencia de contratos | Validar que los DTOs del frontend Angular 21 coincidan con las definiciones del backend. | 6.0 | Diego | Finalizado |
| Sprint 3 | Task NX-866 | NX-866 | Prepare frontend/backend release version for AV2 | NX-1081 | Preparación de perfiles de configuración | Crear perfiles de configuración para Angular 21 y Spring Boot sin valores hardcoded. | 6.0 | César Marín | Finalizado |
...
| Sprint 3 | Task NX-870 | NX-870 | Preserve core frontend-backend flows for Catalog, Inventory and Orders | NX-1089 | Verificación estricta de interfaces | Asegurar que los cambios de DTOs Java se reflejen inmediatamente en las interfaces frontend. | 6.0 | Gerard Gianpier Rojas Mancilla | Por hacer |
...
La evidencia de desarrollo del Sprint 3 se organiza según el alcance AV2: `nexa-platform`, `nexa-webapp` y `nexa-website`. Los commits seleccionados corresponden al incremento técnico y no a la evolución del informe académico.
...
Release de cierre AV2 disponible para revisión. Este repositorio concentra la base backend con Spring Boot Web API, bounded contexts, Shared Kernel, JPA/Hibernate/PostgreSQL, IAM, commands, queries, infrastructure, documentación técnica y release `v1.0.0` con título visible `Nexa Platform - Production Release v1.0.0`. Historial de commits: https://cutt.ly/FyqSp6JR.

| Repository | Branch | Commit Id | Commit Message | Commit Message Body | Commited on (Date) |
|---|---|---|---|---|---|
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `main` | `ec26b31` | `merge: release version v1.0.0` | Release merge for the AV2 review cut. | 2026-06-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `develop` | `12d4be9` | `chore(release): prepare release v1.0.0` | Release metadata and version preparation for `v1.0.0`. | 2026-06-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `main` | `c6f1c47` | `docs(readme): improve README.md structure and repository mapping` | Repository documentation and mapping alignment. | 2026-06-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `main` | `1d03f18` | `feat(community): add CODE_OF_CONDUCT.md and CONTRIBUTING.md` | Community and contribution guidelines for repository governance. | 2026-06-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `main` | `eaa6f4c` | `feat(security): add SECURITY.md and isolate production connection strings` | Security policy and connection string isolation for the deployment evidence. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `main` | `7ebe523` | `merge: release version v0.7.0` | Intermediate release merge before the `v1.0.0` closeout. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `main` | `ea9bbc0` | `docs(cleanup): remove obsolete guide files and local database configs` | Cleanup of obsolete local guides and database configuration files. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `develop` | `63af8e7` | `merge: integrate feature/mejoras-pre-release into develop` | Integration of pre-release improvements into the development branch. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `develop` | `02e423a` | `fix(persistence): resolve startup DB migration concurrency and verifications` | Startup migration concurrency and verification fix. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `develop` | `4c117c9` | `refactor(code): clean up old unused persistence files and bounded contexts` | Cleanup of unused persistence files and bounded context structure. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `develop` | `d6b123f` | `feat(persistence): generate creación de tablas JPA/Hibernate migrations for PostgreSQL` | Initial persistence migration for PostgreSQL. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `develop` | `fb3eeb7` | `fix(persistence): make SeedDataService support idempotent Postgres executions` | Idempotent seed execution support. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `develop` | `274e1d8` | `feat(persistence): add local postgresql database seed seed-local.sql` | Local PostgreSQL seed script for review support. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `develop` | `5cb5962` | `feat(persistence): add local appsettings template appsettings.Local.example.json` | Local application settings template. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `develop` | `5ac6f2d` | `refactor(shared): configure snake_case naming conventions for PostgreSQL tables` | Naming convention alignment for PostgreSQL tables. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `develop` | `461ccba` | `refactor(persistence): update DbContext to use PostgreSQL UseNpgsql` | DbContext provider update for PostgreSQL. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-platform` | `develop` | `3216150` | `feat(persistence): add spring-boot-starter-data-jpa dependency` | PostgreSQL provider dependency for JPA/Hibernate. | 2026-06-15 |
...
| Repository | Branch | Commit Id | Commit Message | Commit Message Body | Commited on (Date) |
|---|---|---|---|---|---|
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `4f1701c` | `Merge branch 'release/v2.0.0' into main` | Consolidation of the WebApp release branch for the AV2 review cut. | 2026-06-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `release/v2.0.0` | `88b4172` | `chore(release): bump package version to 2.0.0 and add release notes` | Version metadata and release notes for `v2.0.0`. | 2026-06-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `c1305dc` | `Merge branch 'feature/cleanup' into develop` | Integration of cleanup changes before the release branch. | 2026-06-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `4f5b959` | `config(git): minimize gitignore and remove history items` | Repository hygiene for the WebApp release trail. | 2026-06-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `afff8e7` | `build(cleanup): delete obsolete local verification logs` | Cleanup of obsolete local verification artifacts. | 2026-06-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `5f1f4ee` | `build(cleanup): delete deprecated firebase routing configuration` | Removal of deprecated routing configuration. | 2026-06-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `bae804c` | `Merge branch 'feature/documentation-compliance' into develop` | Integration of documentation compliance work. | 2026-06-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `daafae5` | `docs(architecture): document clean architecture and frontend DDD patterns` | Documentation of frontend architecture and DDD alignment. | 2026-06-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `ef22c5a` | `docs(wiki): create engineering wiki pages and navigation index` | Engineering wiki pages and navigation index. | 2026-06-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `8b7fa35` | `docs(contrib): enforce structured multiline commit messages` | Contribution documentation for structured commit messages. | 2026-06-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `2db3c82` | `docs(security): update security policy and reporting channels` | Security policy and reporting channel update. | 2026-06-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `143e5c2` | `docs(readme): rewrite main readme with premium layout` | README structure and execution guidance alignment. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `main` | `8299be1` | `Merge branch 'release/v1.8.0' into main` | Intermediate cleanup/layout release before `v2.0.0`. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `release/v1.8.0` | `08f8170` | `chore(release): bump package version to 1.8.0 and add release notes` | Release metadata for the cleanup/layout polish cut. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `75fb950` | `style(ops): apply fluid auto-fit columns to quick-actions grid` | Responsive quick-actions layout adjustment. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `f8a1b8a` | `style(sales): improve create order catalog grid responsiveness` | Responsive catalog grid adjustment for order creation. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `2f1eb35` | `build(cleanup): delete server directory` | Removal of the obsolete local mock server directory. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `48914dc` | `refactor(api): remove useMockApi from context APIs` | Removal of mock API switching from context APIs. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `8cb8ab7` | `feat(store): configure in-memory data store for local resources` | In-memory store for local resource flows not dependent on a live API. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `3282b57` | `feat(shared): configure base API http clients for production` | Base API HTTP clients aligned with the deployed API endpoint strategy. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-webapp` | `develop` | `7568f26` | `build(deps): remove json-server dependency and mock scripts` | Removal of JSON-server dependency and mock scripts. | 2026-06-15 |

*Commits del repositorio `nexa-website`*

Release de cierre AV2 disponible para revisión. `nexa-website v3.0.0` se registra con el título visible `v3.0.0 - Nexa Landing Website Production Release` e incorpora el cierre de Landing Page, navegación, páginas de detalle, correcciones visuales y documentación de repositorio. Historial de commits: https://cutt.ly/0yqSpVDV

| Repository | Branch | Commit Id | Commit Message | Commit Message Body | Commited on (Date) |
|---|---|---|---|---|---|
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `2fce6a1` | `docs(github): configure repository security policies and guides` | Repository governance documents for the AV2 closeout. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `9b5e285` | `docs(readme): rewrite readme format and modernize badges` | README structure and badge modernization. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `a401b76` | `fix(pages): clean content banners and link redirections` | Content banner cleanup and link redirection fixes. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `6fc2bfb` | `feat(navigation): configure dedicated detail views for product and team` | Dedicated detail views for product and team pages. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `7ee4a8e` | `fix(i18n): finalize team roles translation mappings` | Team role translation mapping adjustments. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `d621862` | `feat(platform): introduce product showcase details to platform page` | Product showcase details for the platform page. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `1954001` | `style(company): format team showcase grids and card hover actions` | Team showcase grid formatting and card hover interactions. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `26da256` | `feat(company): integrate pixel-perfect team showcase section` | Team showcase section integration. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `c2596a0` | `fix(legal): update legal pages lang attributes and remove demo tags` | Legal page language attributes and demo tag cleanup. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `b2c8833` | `fix(faq): resolve FAQ list toggles and contrast issues` | FAQ toggle and contrast fixes. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `8d503fa` | `fix(style): register missing status color tokens in design system` | Missing status color tokens for the design system. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `e01c6e9` | `fix(core): update login redirect paths to render production backend` | Login redirect paths aligned with the deployed backend endpoint. | 2026-06-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `a25dff1` | `feat(website): add about content for AV2 release` | Adds About the Product and About the Team pages for the AV2 release path. | 2026-06-11 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `df83d0e` | `docs(readme): fix report repository links and name` | Corrects report repository references. | 2026-06-05 |


La evidencia técnica de cierre AV2 se conserva en los repositorios `nexa-platform`, `nexa-webapp` y `nexa-website`. La trazabilidad GitHub del informe académico se consolida en Project Report Collaboration Insights. Jira, ejecución, Swagger/OpenAPI y releases permanecen en las subsecciones siguientes.
...
El despliegue controlado incluye la Web Application publicada en Render, la Platform API publicada en Render y la base PostgreSQL preparada para el backend. Como referencias de revisión se mantienen los entornos `https://nexa-webapp.onrender.com` para la WebApp y `https://nexa-platform-20wt.onrender.com` para la Platform API. La evidencia de Swagger/OpenAPI se considera parte del despliegue porque permite validar documentación de endpoints desde la API preparada para revisión.
...
La imagen presenta el servicio PostgreSQL configurado en Render. Esta evidencia sustenta la preparación de persistencia relacional para el Sprint 3, alineada con JPA/Hibernate y el despliegue controlado del backend.
...
La foundation compartida integró Shared Kernel, repositories, Unit of Work, JPA/Hibernate/PostgreSQL y Swagger/OpenAPI como base técnica común para la evolución backend. La higiene de GitFlow y release permitió separar ramas, consolidar `nexa-platform v1.0.0`, `nexa-website v3.0.0` y `nexa-webapp v2.0.0`, y mantener trazabilidad del incremento sin declarar operación productiva.
