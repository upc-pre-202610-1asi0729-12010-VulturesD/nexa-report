...
La ejecución del sprint evidencia una distribución funcional de responsabilidades y una comunicación progresiva de resultados. En lugar de concentrar toda la iteración en un único perfil, el equipo repartió la explicación del dominio, diseño, arquitectura, documentación y construcción visible del sitio. Esta organización es consistente con el Student Outcome ABET 3 porque permitió comunicar avances a distintas audiencias mediante informe, evidencias visuales, repositorios y exposición.
...
La evidencia de desarrollo del Sprint 1 corresponde al alcance AV1: estructura Docs-as-Code del informe, documentación inicial del producto, artefactos de discovery, arquitectura base y primera versión del Landing Page. Por ello, la evidencia se concentra en los repositorios `nexa-report` y `nexa-website`.

El repositorio `nexa-report` conserva la evolución documental del informe académico, mientras que `nexa-website` contiene la implementación real del Landing Page desplegado como primer incremento visible del producto. La Web Application y los Web Services se mantienen como alcance posterior, por lo que no se declaran como implementación completada dentro del Sprint 1.
...
| `upc-pre-202610-1asi0729-12010-/nexa-report` | `main` | `ed1bce5` | `docs(front-matter): add student outcome section` | | 2026-04-03 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `9f586da` | `docs(ch1): add startup profile with team background and mission` | | 2026-04-03 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `f702fd6` | `docs(ch1): add solution profile and lean ux hypothesis` | | 2026-04-04 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `413a4d5` | `docs(ch1): add target segments S1, S2 and S3` | | 2026-04-04 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `da2b836` | `docs(ch2): add competitive analysis of Riqra, Drivin and OnTracking` | | 2026-04-04 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `2ac622f` | `docs(ch2): add interview guide and candidate registry` | | 2026-04-05 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `4895fb2` | `docs(ch2): add needfinding with user personas and journey maps` | | 2026-04-05 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `918a120` | `docs(ch2): add big picture event storming session notes` | | 2026-04-06 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `4bf08b9` | `docs(ch2): add ubiquitous language glossary` | | 2026-04-06 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `019c262` | `docs(ch3): add user stories for S1, S2 and S3 with acceptance criteria` | | 2026-04-07 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `fa13f29` | `docs(ch3): add impact mapping for distributor and buyer goals` | | 2026-04-07 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `c550e3a` | `docs(ch3): add product backlog with epics and story points` | | 2026-04-07 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `30b753d` | `docs(ch4): add style guidelines with colors, typography and spacing tokens` | | 2026-04-08 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `34cdf83` | `docs(ch4): add information architecture and navigation systems` | | 2026-04-08 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `cc6c075` | `docs(ch4): add landing page wireframes and mockups` | | 2026-04-09 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `211a045` | `docs(ch4): add domain-driven architecture with C4 context and container diagrams` | | 2026-04-10 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `db4805b` | `docs(ch4): add object-oriented design and class diagrams` | | 2026-04-10 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `33c85a8` | `docs(ch4): add database design and entity-relationship model` | | 2026-04-11 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `f1fd2f9` | `docs(ch5): add software configuration management and tooling` | | 2026-04-11 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `2298c02` | `docs(ch5): tighten sprint evidence` | | 2026-04-22 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `08c48ee` | `docs(ch5): update sprint review evidence blocks and replace jira screenshots` | | 2026-04-23 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `324370e` | `docs(jira): document sprint 1 backlog evidence` | | 2026-04-24 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `5f5b19f` | `docs(ch5): expand development evidence table with real commits from all four repositories` | | 2026-04-24 |
...
| Repository | Branch | Commit Id | Commit Message | Commit Message Body | Commited on (Date) |
|---|---|---|---|---|---|
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `04c39bf` | `chore(repo): initialize website repository baseline` | | 2026-04-01 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `1c8c754` | `feat(project): add first static website prototype` | | 2026-04-01 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `e44e1aa` | `chore(gitflow): merge project-bootstrap into develop` | | 2026-04-01 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `ffa7877` | `style(brand): add Nexa identity and base tokens` | | 2026-04-02 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `8d2b22c` | `feat(landing): add early landing page structure` | | 2026-04-04 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `6777ddd` | `chore(release): prepare website v0.1.0` | | 2026-04-06 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `cbe09a3` | `chore(release): merge website v0.1.0 to main` | | 2026-04-06 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `3734e7a` | `feat(navigation): add first multi-page route map` | | 2026-04-08 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `08f0e93` | `feat(hero): add cold-chain hero media and motion` | | 2026-04-09 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `781e54c` | `feat(landing): organize value proposition styling` | | 2026-04-11 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `e5c13f6` | `chore(release): prepare website v0.2.0` | | 2026-04-14 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `5f2d00d` | `chore(release): merge website v0.2.0 to main` | | 2026-04-14 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `a06ddba` | `feat(platform): move platform overview into pages` | | 2026-04-15 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `ffb25cd` | `feat(company): add company page in final route` | | 2026-04-16 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `9a9eaed` | `feat(faq): add FAQ page in final route` | | 2026-04-17 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `ea68ea2` | `feat(solutions): add solutions overview page` | | 2026-04-18 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `e61e97d` | `feat(solutions): add importers solution page` | | 2026-04-19 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `04eb656` | `feat(solutions): add distributors solution page` | | 2026-04-20 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `211d614` | `feat(solutions): add cold storage solution page` | | 2026-04-21 |
| `upc-pre-202610-1asi0729-12010-VulturesD/nexa-website` | `main` | `83a6dae` | `style(responsive): align layout for first delivery` | | 2026-04-22 |

La selección anterior representa el alcance real del Sprint 1. `nexa-report` documenta el informe académico y la trazabilidad de AV1, mientras que `nexa-website` registra la implementación del Landing Page. La Web Application y los Web Services quedan documentados como fases posteriores del producto, no como implementación completada en AV1.
...
| Repositorio documental | **Versionado y colaborativo** | **nexa-report:** [https://github.com/upc-pre-202610-1asi0729-12010-VulturesD/nexa-report](https://github.com/upc-pre-202610-1asi0729-12010-VulturesD/nexa-report) |
