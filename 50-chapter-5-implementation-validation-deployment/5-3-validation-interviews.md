...
La presente sección documenta el protocolo de entrevistas de validación para AV2 y registra la evidencia disponible en el cierre documental. Su propósito es evaluar si los segmentos definidos comprenden el flujo de Nexa, la propuesta de valor y el uso articulado de la Landing Page, la Web Application y los flujos principales asociados a cada rol. Para AV2 se conserva una entrevista de validación registrada para S3; por ello, los resultados se presentan como evidencia cualitativa limitada y no como validación estadística concluyente del producto.
...
La siguiente tabla registra las entrevistas de validación AV2 disponibles para el cierre documental. La información se limita a participantes, evidencia audiovisual y observaciones incorporadas al reporte. No se declara cobertura completa de todos los segmentos porque solo se cuenta con evidencia verificable de la sesión registrada.
...
La matriz de evaluación relaciona los hallazgos de la validación AV2 con heurísticas de usabilidad, arquitectura de información e inclusive design. Las severidades y recomendaciones se documentan sobre la sesión disponible, por lo que deben interpretarse como observaciones cualitativas y no como resultados representativos de todos los segmentos.
...
| Consistencia y estándares | La interfaz mantiene nombres, acciones, estados y patrones visuales coherentes entre pantallas | Comparativa visual entre la interfaz de la Landing Page y los módulos internos del portal. El análisis del recorrido muestra continuidad en tipografías, botones de acción y distribución de menús. | El participante no reportó rupturas relevantes de consistencia durante el recorrido revisado. | 0 | Preservar el sistema de diseño actual de Nexa y volver a revisarlo con más participantes. |
| Prevención de errores | El flujo reduce errores antes de validar solicitudes, reservar inventario, enviar solicitudes o actualizar despachos | Se revisaron pantallas de resumen y confirmación durante la interacción guiada. | El participante comprendió la función de revisión previa antes de avanzar en el flujo. | 0 | Mantener los mecanismos de confirmación y validarlos en sesiones adicionales. |
...
| Diseño estético y minimalista | Las pantallas priorizan información relevante sin sobrecargar decisiones comerciales, operativas o de compra | Las notas de observación registran una respuesta positiva hacia la limpieza visual del portal. | El participante percibió la interfaz como ordenada durante el recorrido mostrado. | 0 | Conservar la estética limpia y contrastarla con usuarios operativos y comerciales. |
