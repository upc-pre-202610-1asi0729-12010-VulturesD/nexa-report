...
La auditoría Open Source posterior consolidó las correcciones documentales y técnicas en `nexa-website v4.0.1`, `nexa-webapp v2.0.1`, `nexa-platform v1.0.2` y `nexa-report v4.0.2`. Este corte alinea las tecnologías declaradas con Angular 21, TypeScript 5.9, Angular Material 21, Java 21, Spring Boot 3 y PostgreSQL 16; elimina evidencia heredada; actualiza las URLs de Render; corrige el metadata público de OpenAPI; y documenta la integración externa de YouTube utilizada por los videos About-the-Product y About-the-Team.
